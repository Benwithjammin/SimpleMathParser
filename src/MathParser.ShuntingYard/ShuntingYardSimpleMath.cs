...
namespace MathParser.ShuntingYard
{
    public class ShuntingYardSimpleMath : ShuntingYardBase<double, string>
    {
        ...
        {
            { '+', new PrecedensAssociativity(4, PrecedensAssociativity.Asso.Left)},
            ...
            { '/', new PrecedensAssociativity(1, PrecedensAssociativity.Asso.Left)},
        };
